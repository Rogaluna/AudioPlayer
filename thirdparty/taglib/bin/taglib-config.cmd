...
:doit
if /i "%1#" == "--libs#"    echo -LE:/Projects/GitHub/taglib/build/install/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IE:/Projects/GitHub/taglib/build/install/include -IE:/Projects/GitHub/taglib/build/install/include/taglib
if /i "%1#" == "--version#" echo 2.0.2
if /i "%1#" == "--prefix#"  echo E:/Projects/GitHub/taglib/build/install
